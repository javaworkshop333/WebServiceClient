 ...
 * 
 */
@WebServiceClient(name = "SoapCalculatorService", targetNamespace = "http://demo.tutorial.com/", wsdlLocation = "http://localhost:9999/calculator?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:9999/calculator?wsdl");
